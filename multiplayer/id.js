...
//Sala publica e privada

function showSala(salaId) {
    // Oculta todos os conteúdos das salas
    var salas = document.querySelectorAll('.sala-content');
    salas.forEach(function(sala) {
      sala.classList.remove('active');
    });

    // Mostra apenas o conteúdo da sala selecionada
    var salaToShow = document.getElementById(salaId);
    salaToShow.classList.add('active');
  }